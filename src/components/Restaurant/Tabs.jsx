    ...
    <Link to={`/restaurant/${id}/${props.route}`}>
      <div
        className={classnames("text-gray-500 relative font-light", {
          "text-zomato-secondary font-semibold": props.isActive,
        })}
...
function Tabs() {
  ...
  return (
    <>
      <div className="relative flex items-center gap-8 pb-4 overflow-x-auto border-b-2 scrollbar-hide md:gap-20">
        {tabs.map((tab) => (
